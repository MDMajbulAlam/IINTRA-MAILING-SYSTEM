...
public class Forward extends javax.swing.JFrame {
    ...
    public Forward(String uname, int mid) 
    {
        initComponents();
        this.uname=uname;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Forward.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
